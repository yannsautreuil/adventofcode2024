    ...
    for i in range(0, len(lines), 4):
        ...
        if button_a_match and button_b_match and prize_match:
            ...
            result.append([
                ...
                int(prize_match.group(1))+10000000000000,     # X of Prize
                int(button_a_match.group(2)),  # Y of Button A
                int(button_b_match.group(2)),  # Y of Button B
                int(prize_match.group(2))+10000000000000,     # Y of Prize
            ])
...
def calculate_tokens(values_list:list):
    ...
    for i in range(0, len(values_list)):
        ...
        if isinstance(A_value, Integer) and isinstance(B_value, Integer):
